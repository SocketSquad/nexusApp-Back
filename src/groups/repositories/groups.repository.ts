...
export class GroupRepository implements IGroupRepository {
  ...
  async findAll(filter: any = {}): Promise<Group[]> {
    return this.groupModel.find(filter).populate('owner', 'username email').populate('members.userId', 'username email').populate('messages','senderId content type hasAttachments isEdited createdAt').exec();
  }
